...
Public Class ExcelExport
    ...
    Private Sub SetupExcel(ByVal Name As String)
        ...
        Melem2.AppendChild(DataElem("Author", "Truevue"))
        Melem2.AppendChild(DataElem("LastAuthor", "Truevue"))
        Melem2.AppendChild(DataElem("Created", Now))
        Melem2.AppendChild(DataElem("LastSaved", Now))
        Melem2.AppendChild(DataElem("Company", "Truevue"))
        Melem2.AppendChild(DataElem("Version", "11.6568"))
